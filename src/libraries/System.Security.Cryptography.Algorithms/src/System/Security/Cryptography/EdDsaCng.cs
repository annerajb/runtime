...
namespace System.Security.Cryptography
{
    public partial class EdDsa : AsymmetricAlgorithm
    {
        ...
        {
            return new EdDsaImplementation.EdDsaCng();
        }
        ...
        // /// </param>
        // public static EdDsa Create(ECCurve curve)
        // {
        //     return new EdDsaImplementation.EdDsaCng(curve);
        // }
        ...
        /// </param>
        // public static EdDsa Create(ECParameters parameters)
        // {
        //     EdDsa ec = new EdDsaImplementation.EdDsaCng();
    ...
    {
        public sealed partial class EdDsaCng : EdDsa
        {
            ...
            private void ImportFullKeyBlob(byte[] ecfullKeyBlob, bool includePrivateParameters)
            {
                ...
                _key.SetHandle(keyHandle, AlgorithmName.EdDsa);
