...
namespace System.Security.Cryptography
{
    ...
    internal static partial class EdDsaImplementation
    {
        ...
        public sealed partial class EdDsaOpenSsl : EdDsa
        {
            ...
            /*/// <summary>
            /// Create an EdDsaOpenSsl algorithm with a named curve.
            /// </summary>
            ...
            /// <summary>
            ///     Create an EdDsaOpenSsl algorithm with a random 521 bit key pair.
            /// </summary>
            public EdDsaOpenSsl()
                //: this(521)
            {
                //_key = new ECOpenSsl(EccCurve.NamedCurves.brainpoolP512t1);
            }

            /*/// <summary>
            ///     Creates a new EdDsaOpenSsl object that will use a randomly generated key of the specified size.
            /// </summary>
