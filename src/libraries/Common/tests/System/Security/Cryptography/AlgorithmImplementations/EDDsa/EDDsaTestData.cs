...
namespace System.Security.Cryptography.Tests
{
    ...
    internal static class EDDsaTestData
    {
        ...
        internal static EDDsaParameters GetNistP256ExplicitTestData()
        {
            EDDsaParameters p = new EDDsaParameters();
            p.Key = ("96E476F7473CB17C5B38684DAAE437277AE1EFADCEB380FAD3D7072BE2FFE5F0").HexToByteArray();
            return p;
        }

        // internal static EDDsaParameters GetNistP224KeyTestData()
        // {
        ...
        // internal static EDDsaParameters GetNistP521DiminishedCoordsParameters()
        // {
        //     return new EDDsaParameters
        //     {
        ...
        // internal static EDDsaParameters GetNistP521Key2()
        // {
        //     return new EDDsaParameters
        //     {
        //         Curve = ECCurve.NamedCurves.nistP521,
        ...
        internal static EDDsaParameters GetNistP256ReferenceKey()
        {
            // From Suite B Implementers's Guide to FIPS 186-3 (ECDSA)
            // Section D.1.1
            return new EDDsaParameters
            {
                Key = "101A81746CDEBB4389403B8C8EA6225A74E0FD820A2EFB8B074E1CE140FDF91A".HexToByteArray()
            };
        }

        // internal static EDDsaParameters GetNistP256ReferenceKeyExplicit()
        // {
        //     // From Suite B Implementers's Guide to FIPS 186-3 (ECDSA)
        //     // Section D.1.1
        //     return new EDDsaParameters
        ...
        // internal static readonly EDDsaParameters BrainpoolP160r1Key1 =
        //     new EDDsaParameters
        //     {
        ...
        // internal static readonly EDDsaParameters Sect163k1Key1 =
        //     new EDDsaParameters
        //     {
        ...
        // internal static readonly EDDsaParameters Sect163k1Key1Explicit =
        //     new EDDsaParameters
        //     {
        //         Curve =
        //         {
        ...
        // internal static readonly EDDsaParameters Sect283k1Key1 =
        //     new EDDsaParameters
        //     {
        ...
        // internal static readonly EDDsaParameters C2pnb163v1Key1 =
        //     new EDDsaParameters
        //     {
        ...
        // internal static readonly EDDsaParameters C2pnb163v1Key1Explicit =
        //     new EDDsaParameters
        //     {
        //         Curve =
        //         {
